...
document.addEventListener('DOMContentLoaded', function() {
    ...
    buttons.forEach(button => {
        ...
        $(document).ready(function() {
            ...
            $('.answer-btn').on('click', function() {
                ...
                console.log('ID USER NIH: ' + userId);
                // Store the clicked ID in a variable
                selectedAnswerId = clickedId;
            });
                ...
                if (answerId) {
                    $.ajax({
                        ...
                        data: {
                            answerId: answerId,
                            soalId: soalId,
                            userid: userId //masih belum benar
                        },
    ...
    var answerId = selectedAnswerId;
    var soalId = <?php echo $soalID; ?>;
    var userId = <?php echo $userId; ?>; // Pastikan variabel ini sudah didefinisikan dengan benar
